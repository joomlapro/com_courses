...
<script type="text/javascript">
	Joomla.submitbutton = function(task) {
		if (task == 'course.cancel' || document.formvalidator.isValid(document.getElementById('adminForm'))) {
...
<div class="edit item-page<?php echo $this->pageclass_sfx; ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_courses&c_id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-vertical">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('course.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('course.cancel')">
		...
		<fieldset>
			<ul class="nav nav-tabs">
				...
				<?php if ($params->get('show_images_frontend')): ?>
					<li><a href="#images" data-toggle="tab"><?php echo JText::_('COM_COURSES_IMAGES') ?></a></li>
				<?php endif; ?>
				<li><a href="#publishing" data-toggle="tab"><?php echo JText::_('COM_COURSES_PUBLISHING') ?></a></li>
				<li><a href="#language" data-toggle="tab"><?php echo JText::_('JFIELD_LANGUAGE_LABEL') ?></a></li>
				<li><a href="#metadata" data-toggle="tab"><?php echo JText::_('COM_COURSES_METADATA') ?></a></li>
			</ul>
				...
				<div class="tab-pane" id="publishing">
					...
					<?php if (is_null($this->item->id)): ?>
						<div class="control-group">
							...
							<div class="controls">
								<?php echo JText::_('COM_COURSES_ORDERING'); ?>
							</div>
						</div>
					<?php endif; ?>
				</div>
