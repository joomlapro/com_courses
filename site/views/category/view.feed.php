 ...
 * @since       3.2
 */
class CoursesViewCategory extends JViewCategoryfeed
{
	/**
	...
	protected function reconcileNames($item)
	{
		...
		{
			$item->description .= '<p class="feed-readmore"><a target="_blank" href ="' . $item->link . '">' . JText::_('COM_COURSES_FEED_READMORE') . '</a></p>';
		}
