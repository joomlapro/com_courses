...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_COURSES_BATCH_OPTIONS'); ?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_COURSES_BATCH_TIP'); ?></p>
		...
		<?php if ($published >= 0): ?>
			<div class="control-group">
				<div class="controls">
					<?php echo JHtml::_('batch.item', 'com_courses'); ?>
				</div>
			</div>
		<?php endif; ?>
	</div>
	<div class="modal-footer">
		...
		<button type="submit" class="btn btn-primary" onclick="Joomla.submitbutton('course.batch');">
